...
<template>
  <a-layout style="min-height: 100vh">
    ...
    <a-layout>
      <a-layout-header style="background: #fff; padding: 0; text-align: center; font-weight: bold">
        机械设计工具箱
      </a-layout-header>
      <a-layout-content style="margin: 16px">
        <div :style="{ padding: '24px', background: '#fff', minHeight: '360px', borderRadius: '8px' }">
          <div v-if="selectedKeys[0] === 'dashboard'" style="text-align: center">
            <h2>欢迎使用 MechBox (Vue 版)</h2>
            <p>基于 Vue 3 + Ant Design Vue 4.0 构建，请在左侧选择计算模块。</p>
          </div>
          <div v-else>
            正在构建 {{ selectedKeys[0] }} 模块...
          </div>
        </div>
      </a-layout-content>
    </a-layout>
